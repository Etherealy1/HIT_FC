...
#define IO5_H GPIOD->BSRRL = GPIO_Pin_12
#define IO5_L GPIOD->BSRRH = GPIO_Pin_12
#define IO6_H GPIOD->BSRRL = GPIO_Pin_13
#define IO6_L GPIOD->BSRRH = GPIO_Pin_13
#define IO7_H GPIOD->BSRRL = GPIO_Pin_14
#define IO7_L GPIOD->BSRRH = GPIO_Pin_14
#define IO8_H GPIOD->BSRRL = GPIO_Pin_15
#define IO8_L GPIOD->BSRRH = GPIO_Pin_15
typedef struct 
{
	u8 allOk;
	u8 lowVt;//低电压
...
void Dvr_IO_Init(void);
void Dvr_IOPWM_Init(void);
