...
void Dvr_IO_Init()
{
	...
	GPIO_ResetBits(GPIOD, GPIO_Pin_15);//IO5PD12 IO6PD13 IO7PD14 IO8PD15
}
void Dvr_IOPWM_Init()
{
  ...
  RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE);//使能GPIOB时钟；
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 ;//IO3 IO4
  ...
  GPIO_PinAFConfig(GPIOB, GPIO_PinSource1, GPIO_AF_TIM3);
	...
	TIM_TimeBaseStructure.TIM_Prescaler = 20;//21-1
