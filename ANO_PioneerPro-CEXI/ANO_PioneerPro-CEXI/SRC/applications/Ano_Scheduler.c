...
extern u16 Uwb_x,Uwb_y,Uwb_z;
extern u16 youmen,distance;
...
{	
	...
	/*电机输出控制*/
	Motor_Ctrl_Task(2);	//输入为计数计及每次执行间隔时间 怠速准备
...
static void Loop_200Hz(void)	//5ms执行一次
{
	...
	/*姿态角度环控制*/
	Att_2level_Ctrl(5e-3f,CH_N);//5e-3f 5ms一周期
...
//////////////////////////////////////////////////////////////////////		
	...
	ANODT_SendF1(youmen);
	ANODT_SendF2(distance);
	ANODT_SendF3(Uwb_x,Uwb_y,Uwb_z);
}
