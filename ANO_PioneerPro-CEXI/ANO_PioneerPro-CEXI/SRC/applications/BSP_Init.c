...
u8 All_Init()
{
	...
	Dvr_IO_Init(); 						//IO5-8初始化
	Dvr_IOPWM_Init();					//IO3 IO4PWM初始化
...
//	}
	...
	//
	AnoDTSendStr(USE_HID|USE_U2,SWJ_ADDR,LOG_COLOR_GREEN,"SYS init OK!");//初始化完成发送信息
	return (1);
}
